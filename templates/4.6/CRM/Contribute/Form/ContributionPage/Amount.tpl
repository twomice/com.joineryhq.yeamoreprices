{*
 * ==========================================================================
 * This is an exact copy of CiviCRM's CRM/Contribute/Form/ContributionPage/Amount.tpl,
        ...
        <td>{$form.amount_label.html}</td>
            ...
            <tr><td colspan="2">
                <fieldset><legend>{ts}Fixed Contribution Options{/ts}</legend>
                     ...
                     * This section removed and replaced with include statement
                     * below, through END: MODIFIED.com.joineryhq.yeamoreprices
                    <table id="map-field-table">
                        ...
                        {section name=loop start=1 loop=15}
                    ...
                    *}
                    {include file="CRM/Yeamoreprices/Contribute/Form/ContributionPage/FixedContributionOptions.tpl"}
                    {**
